...
import java.util.*; class fileserver
{
public static void main(String args[])
{
try
{
ServerSocket obj=new ServerSocket(1391); while(true)
{
...
FileReader f=new FileReader(str); BufferedReader b=new BufferedReader(f); String s; while((s=b.readLine())!=null)
{
