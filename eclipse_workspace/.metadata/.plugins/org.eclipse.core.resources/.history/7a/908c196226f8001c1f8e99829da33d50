...
public class CalculatorServiceServiceLocator extends org.apache.axis.client.Service implements org.axis.CalculatorServiceService {
    ...
    private java.lang.String CalculatorService_address = "http://localhost:8080/Webservicedemo/services/CalculatorService";
    ...
    public org.axis.CalculatorService getCalculatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.axis.CalculatorServiceSoapBindingStub _stub = new org.axis.CalculatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.axis.CalculatorService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.axis.CalculatorServiceSoapBindingStub _stub = new org.axis.CalculatorServiceSoapBindingStub(new java.net.URL(CalculatorService_address), this);
                _stub.setPortName(getCalculatorServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://axis.org", "CalculatorServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://axis.org", "CalculatorService"));
        }
